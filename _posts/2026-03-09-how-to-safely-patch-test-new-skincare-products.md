...
Patch testing is one of the simplest (and smartest) steps you can take before applying a new product to your entire face.

This guide explains how to patch test properly, how long to wait, and what to look for — so you can protect your skin while building a routine that works.
...
While patch testing cannot guarantee you won’t react later, it significantly reduces the risk of widespread irritation.
...
Use a pea-sized amount for creams or 1–2 drops for serums.  
Leave it uncovered unless the product instructions say otherwise.
...
Mild tingling can be normal. Significant redness, swelling, or prolonged burning is not.

### **Exfoliating Acids (AHAs, BHAs)**
Brief tingling may occur. Strong stinging or visible inflammation suggests irritation.
...
Introduce one new product at a time, ideally spaced 1–2 weeks apart.
...
A slow introduction reduces irritation risk and helps your skin adjust.
...
At minimum, wait 24 hours. For active ingredients, 48 hours is ideal.

### **Can I patch test on my face?**
Yes — applying along the jawline is common. The inner forearm is often safer for initial testing.

### **What if I feel mild tingling?**
Mild, brief tingling can occur with active ingredients. Persistent burning or redness is not normal.
